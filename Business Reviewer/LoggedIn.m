...
- (void)viewDidLoad
{
    ...
    //  NSString * loginBody = @"";
    //  [httpRequest loginRequest:loginBody theMethod:@"fetchContacts"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // tableData = [firstname copy];
    tableData = [friendIDs copy];
...
{
    NSMutableArray *ar= [responseDictionary valueForKey:@"contacts"];
    NSMutableArray *dictionary=ar;
    
    firstname= [dictionary valueForKey:@"fname"];
